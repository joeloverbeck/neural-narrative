...
from src.base.constants import PLOT_BLUEPRINTS_GENERATION_TOOL_FILE, PLOT_BLUEPRINTS_GENERATION_PROMPT_FILE
...
class PlotBlueprintsFactory(BaseConceptFactory):
    ...
    def __init__(self, playthrough_name: str,
        ...
        super().__init__(playthrough_name,
            ...
            places_descriptions_factory,
                         ...
                         PLOT_BLUEPRINTS_GENERATION_TOOL_FILE, prompt_file=
                         PLOT_BLUEPRINTS_GENERATION_PROMPT_FILE, user_content=
    ...
    def create_product(self, arguments: dict):
        ...
        if not plot_blueprint:
            return PlotBlueprintsProduct(None, is_valid=False, error=
            'The LLM failed to produce a plot blueprint.')
