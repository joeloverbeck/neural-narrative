# src/concepts/factories/interesting_dilemmas_factory.py
...
class InterestingDilemmasFactory(BaseConceptFactory):
    def __init__(
        ...
        super().__init__(
            ...
            user_content=RequiredString(
                "Write a list of three intriguing moral and ethical dilemmas that "
    ...
    def create_product(self, arguments: dict):
        ...
        for i in range(1, 4):
            ...
            dilemmas.append(RequiredString(arguments.get(key)))
