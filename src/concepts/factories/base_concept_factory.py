...
class BaseConceptFactory(BaseToolResponseProvider):
    ...
    def __init__(self, playthrough_name: str,
            ...
            PlacesDescriptionsProvider,
                 ...
                 PlayerAndFollowersInformationFactory, tool_file: str, prompt_file:
            str, user_content: str, filesystem_manager: Optional[
    ...
    def get_prompt_kwargs(self) -> dict:
        return ConceptsManager(self._playthrough_name).get_prompt_data(self
                                                                       ._places_descriptions_factory, self.
                                                                       _player_and_followers_information_factory)
