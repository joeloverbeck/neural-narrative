...
from src.characters.products.produce_self_reflection_product import ProduceSelfReflectionProduct
...
class ProduceSelfReflectionAlgorithm:
    ...
    def __init__(self, playthrough_name: str, character_identifier: str,
        self_reflection_factory: SelfReflectionFactory,
                 ...
                 DirectVoiceLineGenerationAlgorithmFactory, filesystem_manager:
    ...
    def do_algorithm(self) -> ProduceSelfReflectionProduct:
        product = cast(SelfReflectionProduct, self._self_reflection_factory
                       .generate_product())
        ...
        self._filesystem_manager.append_to_file(self._filesystem_manager.
                                                get_file_path_to_character_memories(self._playthrough_name,
                                                                                    self._character_identifier,
                                                                                    character.name),
                                                '\n' + product.get())
        voice_line_file_name = (self.
                                _direct_voice_line_generation_algorithm_factory.
                                create_algorithm(character.name, product.get(), character.
                                                 voice_model).direct_voice_line_generation())
