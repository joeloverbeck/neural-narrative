...
class CharacterInformationProvider:
    ...
    def get_information(self) -> str:
        ...
        character_information = character_information.format(**{'name':
                                                                    character.name,
                                                                'description': character.description,
                                                                'personality': character.personality,
                                                                'profile': character.
                                                             profile, 'likes': character.likes, 'dislikes': character.
                                                             dislikes, 'secrets': character.secrets, 'speech_patterns':
                                                                    character.speech_patterns,
                                                                'health': character.health,
                                                                'equipment': character.equipment, 'memories': memories})
