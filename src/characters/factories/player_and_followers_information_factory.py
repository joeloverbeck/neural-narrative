...
class PlayerAndFollowersInformationFactory:
    ...
    def __init__(self, party_data_for_prompt_factory:
    PartyDataForPromptFactory, filesystem_manager: Optional[
    ...
    def get_information(self) -> str:
        ...
        party_data_for_prompt = (self._party_data_for_prompt_factory.
                                 get_party_data_for_prompt())
