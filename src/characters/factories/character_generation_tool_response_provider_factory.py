from src.characters.providers.character_generation_tool_response_provider import CharacterGenerationToolResponseProvider
...
class CharacterGenerationToolResponseProviderFactory:
    ...
    def create_response_provider(self, places_templates_parameter:
    PlacesTemplatesParameter):
        return CharacterGenerationToolResponseProvider(self.
                                                       _playthrough_name, places_templates_parameter, self.
                                                       _produce_tool_response_strategy_factory, self.
                                                       _user_content_for_character_generation_factory, self.
