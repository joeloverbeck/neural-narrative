...
class SecretsFactory(BaseToolResponseProvider):
    ...
    def __init__(self, playthrough_name: str, character_identifier: str,
            ...
            PlacesDescriptionsProvider, filesystem_manager: Optional[
                FilesystemManager] = None, character_memories: Optional[
        ...
        self._character_memories = character_memories or CharacterMemories(self
                                                                           ._playthrough_name)
    ...
    def get_user_content(self) -> str:
        return (
            'Create secrets for a character that are compelling and truly worth being hidden. Follow the provided instructions.'
        )
    ...
    def get_prompt_kwargs(self) -> dict:
        ...
        prompt_data.update({'name': character.name, 'description':
            character.description, 'personality': character.personality,
                            'profile': character.profile, 'likes': character.likes,
                            'dislikes': character.dislikes, 'secrets': character.secrets,
                            'speech_patterns': character.speech_patterns, 'health':
                                character.health, 'equipment': character.equipment})
