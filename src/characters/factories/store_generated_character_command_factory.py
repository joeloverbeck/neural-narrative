...
class StoreGeneratedCharacterCommandFactory:
    ...
    def create_store_generated_character_command(self, character_data: dict
                                                 ) -> StoreGeneratedCharacterCommand:
        return StoreGeneratedCharacterCommand(self._playthrough_name,
                                              character_data, self._match_voice_data_to_voice_model_algorithm)
