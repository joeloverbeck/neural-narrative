from src.characters.factories.character_generation_guidelines_provider import CharacterGenerationGuidelinesProvider
...
class CharacterGenerationGuidelinesProviderFactory:
    ...
    ProduceToolResponseStrategyFactory, places_descriptions_provider:
    ...
    def create_provider(self) -> CharacterGenerationGuidelinesProvider:
        return CharacterGenerationGuidelinesProvider(self.
                                                     _produce_tool_response_strategy_factory, self.
                                                     _places_descriptions_provider, self._place_manager_factory,
