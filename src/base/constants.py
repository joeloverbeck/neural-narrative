...
PARENT_TEMPLATE_TYPE = {TemplateType.WORLD: TemplateType.STORY_UNIVERSE,
                        TemplateType.REGION: TemplateType.WORLD, TemplateType.AREA:
                            TemplateType.REGION, TemplateType.LOCATION: TemplateType.AREA}
TEMPLATE_FILES = {TemplateType.STORY_UNIVERSE:
                      STORY_UNIVERSES_TEMPLATE_FILE, TemplateType.WORLD:
                      WORLDS_TEMPLATES_FILE, TemplateType.REGION: REGIONS_TEMPLATES_FILE,
                  TemplateType.AREA: AREAS_TEMPLATES_FILE, TemplateType.LOCATION:
                      LOCATIONS_TEMPLATES_FILE}
PARENT_KEYS: Dict[TemplateType, str] = {TemplateType.REGION: 'world',
                                        TemplateType.AREA: 'region', TemplateType.LOCATION: 'area'}
CHARACTER_INFORMATION_BLOCK: str = (
    'data/prompting/blocks/character_information.txt')
PLACES_DESCRIPTIONS_BLOCK: str = (
    'data/prompting/blocks/places_descriptions.txt')
...
PLACE_DESCRIPTION_TOOL_FILE: str = (
    'data/prompting/places/place_description_tool.json')
TRAVEL_NARRATION_TOOL_FILE: str = (
    'data/prompting/places/travel_narration_tool.json')
...
GOALS_GENERATION_TOOL_FILE: str = (
...
AREA_GENERATION_PROMPT_FILE: str = (
...
TRAVEL_NARRATION_PROMPT_FILE: str = (
    'data/prompting/places/travel_narration_prompt.txt')
...
IMAGE_GENERATION_PROMPT_FILE: str = (
    'data/prompting/image_generation_prompt.txt')
...
VOICE_AGES = ['CHILDLIKE', 'TEENAGE', 'YOUNG ADULT/ADULT', 'MIDDLE-AGED',
              'ELDERLY']
VOICE_EMOTIONS = ['CALM', 'HAPPY/JOYFUL', 'SAD/MELANCHOLIC',
                  'ANGRY/AGGRESSIVE', 'ANXIOUS/FRIGHTENED', 'CONFIDENT/DETERMINED',
                  'SERIOUS/FIRM', 'HOPEFUL', 'SURPRISED', 'PLAYFUL', 'EXCITED']
VOICE_TEMPOS = ['FAST', 'SLOW', 'MODERATE']
VOICE_VOLUMES = ['WHISPERING', 'SOFT-SPOKEN/QUIET', 'NORMAL VOLUME', 'LOUD']
VOICE_TEXTURES = ['GRAVELLY/RASPY', 'SMOOTH', 'NASAL', 'CRISP', 'MUFFLED',
                  'WHISPERY/AIRY', 'METALLIC/MECHANICAL', 'GUTTURAL']
VOICE_TONES = ['WARM', 'NEUTRAL', 'COLD', 'AUTHORITATIVE']
VOICE_STYLES = ['FORMAL', 'CASUAL', 'INTENSE/DRAMATIC', 'MONOTONE',
                'DRAWLING', 'FLIRTATIOUS', 'HUMOROUS/SARCASTIC', 'MELODIC', 'NARRATIVE',
                'INSTRUCTIONAL']
VOICE_PERSONALITIES = ['INNOCENT/NAIVE', 'YOUTHFUL', 'ENERGETIC',
                       'HEROIC/BRAVE', 'PASSIONATE', 'ADVENTUROUS/DRIVEN', 'OPTIMISTIC',
                       'NOBLE', 'SULTRY', 'WITTY', 'KIND', 'CHARMING', 'WISE/PHILOSOPHICAL',
                       'STOIC', 'ECCENTRIC', 'MYSTERIOUS', 'SKEPTICAL', 'WORLD-WEARY',
                       'CYNICAL/PESSIMISTIC', 'PARANOID', 'MANIPULATIVE/SCHEMING', 'SLY',
                       'VILLAINOUS']
VOICE_SPECIAL_EFFECTS = ['NO SPECIAL EFFECTS', 'ROBOTIC/SYNTHESIZED',
                         'ALIEN', 'DEMON-LIKE', 'MAGICAL', 'DISTORTED', 'GHOSTLY/ECHOED', 'RETRO']
LOCATION_TYPES = ['APARTMENT BUILDING', 'BAR', 'BURIAL SITE', 'BROTHEL',
                  'CAVE SYSTEM', 'CHAMBER', 'CLEARING', 'COLLEGE', 'FORGE', 'FORTRESS',
                  'GREENHOUSE', 'HOSPITAL', 'INN', 'LABYRINTH', 'LIBRARY', 'MALL',
                  'MANSION', 'MINE', 'OASIS', 'PARK', 'POLICE STATION', 'TRAINING GROUND',
                  'WOODS']
