...
class PlaythroughManager:
    ...
    def _update_playthrough_metadata_identifier(self, key: str, new_value: str
        ...
        self._filesystem_manager.save_json_file(playthrough_metadata, self.
                                                _filesystem_manager.get_file_path_to_playthrough_metadata(self.
                                                                                                          _playthrough_name))

    def has_ongoing_dialogue(self, playthrough_name):
        return os.path.exists(self._filesystem_manager.
                              get_file_path_to_ongoing_dialogue(playthrough_name))

    def update_player_identifier(self, new_player_identifier: str):
        self._update_playthrough_metadata_identifier('player_identifier',
                                                     new_player_identifier)
    ...
    def get_story_universe_template(self) -> str:
        playthrough_metadata_file = (self._filesystem_manager.
                                     load_existing_or_new_json_file(self._filesystem_manager.
                                                                    get_file_path_to_playthrough_metadata(
            self._playthrough_name)))
    ...
    def add_follower(self, character_identifier):
        playthrough_metadata: dict = (self._filesystem_manager.
                                      load_existing_or_new_json_file(self._filesystem_manager.
                                                                     get_file_path_to_playthrough_metadata(
            self._playthrough_name)))
    ...
    def remove_follower(self, character_identifier):
        playthrough_metadata: dict = (self._filesystem_manager.
                                      load_existing_or_new_json_file(self._filesystem_manager.
                                                                     get_file_path_to_playthrough_metadata(
            self._playthrough_name)))
        playthrough_metadata['followers'] = [follower for follower in
                                             playthrough_metadata['followers'] if follower !=
    ...
    def update_current_place(self, new_current_place_identifier: str):
        self._update_playthrough_metadata_identifier('current_place',
                                                     new_current_place_identifier)
        logger.info(
            f"Updated playthrough current place to '{new_current_place_identifier}'."
        )

    def add_to_adventure(self, entry: str):
        file_path = self._filesystem_manager.get_file_path_to_adventure(self
                                                                        ._playthrough_name)
