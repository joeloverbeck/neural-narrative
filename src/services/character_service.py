...
class CharacterService:
    ...
    def add_followers(playthrough_name, character_ids):
        ...
        for character_id in character_ids:
            movement_manager.add_follower(character_id, playthrough_manager
    ...
    def remove_followers(playthrough_name, follower_ids):
        ...
        for follower_id in follower_ids:
            movement_manager.remove_follower(follower_id,
    ...
    def generate_character(playthrough_name: str, guideline: str):
        ...
        GenerateCharacterCommandFactoryComposer(playthrough_name
            ...
            places_templates_parameter, place_character_at_current_place=
            True, user_content=guideline).execute()
