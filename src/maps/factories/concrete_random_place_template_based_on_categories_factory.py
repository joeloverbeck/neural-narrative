...
class ConcreteRandomPlaceTemplateBasedOnCategoriesFactory(
    ...
    def __init__(self, place_selection_manager: PlaceSelectionManager,
    ...
    def create_random_place_template_based_on_categories(self,
        ...
        filtered_places = (self._place_selection_manager.
                           filter_places_by_categories(place_templates, categories, self.
                                                       _location_type))
        random_place = self._place_selection_manager.select_random_place(
            filtered_places)
        if not random_place:
            return ConcretePlaceTemplateProduct(None, is_valid=False, error
