...
class PlaceDescriptionsForPromptFactory:
    ...
    def _determine_location_description(
        place_full_data: Dict[str, Dict[str, RequiredString]]
    ) -> str:
        location_description = ""

        if (
            place_full_data["location_data"]
            and place_full_data["location_data"]["description"].value
        ):
            location_description = (
                "Location Description: "
                + place_full_data["location_data"]["description"].value
            )

        return location_description

    def create_place_descriptions_for_prompt(self) -> Dict[str, RequiredString]:
        ...
        return {
            "story_universe_description": story_universe_description.value,
            "world_description": place_full_data["world_data"]["description"].value,
            "region_description": place_full_data["region_data"]["description"].value,
            "area_description": place_full_data["area_data"]["description"].value,
