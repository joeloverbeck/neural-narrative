...
class ConcreteCurrentPlaceFactory(CurrentPlaceFactory):
    ...
    def __init__(self, playthrough_name: str, playthrough_manager: Optional
    ...
    def create_current_place(self) -> CurrentPlaceProduct:
        ...
        return ConcreteCurrentPlaceProduct(map_file[self.
                                           _playthrough_manager.get_current_place_identifier()], is_valid=True
                                           )
