...
class RandomTemplateTypeMapEntryProviderFactoryComposer:
    ...
    def compose_factory(self) -> RandomTemplateTypeMapEntryProviderFactory:
        ...
        place_selection_manager = PlaceSelectionManager(place_manager_factory,
                                                        template_repository)
        ...
        create_map_entry_for_playthrough_command_provider_factory = (
            CreateMapEntryForPlaythroughCommandProviderFactory(self.
                                                               _playthrough_name))
        return RandomTemplateTypeMapEntryProviderFactory(self.
                                                         _playthrough_name,
            random_place_template_based_on_categories_factory,
            create_map_entry_for_playthrough_command_provider_factory,
