...
class PlacesDescriptionsProvider:
    ...
    def __init__(self, place_descriptions_for_prompt_factory:
    PlaceDescriptionsForPromptFactory, filesystem_manager: Optional[
    ...
    def get_information(self) -> str:
        ...
        places_descriptions = places_descriptions.format(**self.
                                                         _place_descriptions_for_prompt_factory.
                                                         create_place_descriptions_for_prompt())
