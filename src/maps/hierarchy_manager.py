...
class HierarchyManager:
    ...
    def get_place_hierarchy(
        ...
        while current_place_id:
            ...
            if place_type == TemplateType.WORLD:
                ...
                current_place_id = RequiredString(place.get("world"))
                ...
                current_place_id = RequiredString(region_identifier)
            elif place_type == TemplateType.LOCATION:
                hierarchy["location"] = place
                current_place_id = RequiredString(place.get("area"))
            else:
    ...
    def get_father_identifier(self, place_identifier: RequiredString) -> RequiredString:
        """
        ...
        Args:
            place_identifier (RequiredString): The identifier of the place.

        Returns:
            RequiredString: The father identifier of the given place.
        ...
        if place_type == TemplateType.AREA:
            ...
            return RequiredString(father_identifier)
        elif place_type == TemplateType.LOCATION:
