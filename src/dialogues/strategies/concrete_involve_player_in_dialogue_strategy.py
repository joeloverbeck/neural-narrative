...
class ConcreteInvolvePlayerInDialogueStrategy(InvolvePlayerInDialogueStrategySubject):
    def __init__(self, player_identifier: Optional[str],
        ...
        self._introduce_player_input_into_dialogue_command_factory = introduce_player_input_into_dialogue_command_factory
