...
class SetupDialogueCommand(Command):
    ...
    def __init__(self, playthrough_name: str, player_identifier: str,
                 participants: Participants, purpose: Optional[str],
    ...
    def execute(self) -> None:
        ...
        self._handle_possible_existence_of_ongoing_conversation_command_factory.create_handle_possible_existence_of_ongoing_conversation_command(
            messages_to_llm, transcription).execute()
        LaunchDialogueCommand(self._playthrough_name, self.
                              _player_identifier, self._participants, self._purpose,
                              messages_to_llm, transcription, self._dialogue_observer, self.
                              _player_input_factory, self.
                              _message_data_producer_for_introduce_player_input_into_dialogue_strategy
