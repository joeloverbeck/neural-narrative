...
class CharacterChoiceDialogueSystemContentForPromptProviderFactory:
    ...
    def __init__(self, player_identifier: str, filesystem_manager:
    ...
    def create_character_choice_dialogue_system_content_for_prompt_provider(
        ...
        return CharacterChoiceDialogueSystemContentForPromptProvider(
            participants, self._player_identifier, transcription, self.
            _filesystem_manager.read_file(CHOOSING_SPEECH_TURN_PROMPT_FILE),
            self._filesystem_manager.read_json_file(SPEECH_TURN_TOOL_FILE),
