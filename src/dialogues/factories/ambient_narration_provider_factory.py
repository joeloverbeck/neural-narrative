...
class AmbientNarrationProviderFactory:
    ...
    def create_provider(self, transcription: Transcription
                        ) -> AmbientNarrationProvider:
        return AmbientNarrationProvider(self._playthrough_name,
                                        transcription, self._produce_tool_response_strategy_factory,
                                        self._weathers_manager, self._place_description_manager)
