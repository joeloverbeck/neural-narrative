...
class OrchestrateDialogueProductionCommandComposer:
    def __init__(self, playthrough_name: str, participants: List[str], llm_client: LlmClient, model: str,
    ...
    def compose(self) -> OrchestrateDialogueProductionCommand:
        ...
        produce_dialogue_command = ProduceDialogueCommand(self._dialogue_factory, summarize_dialogue_command_factory,
