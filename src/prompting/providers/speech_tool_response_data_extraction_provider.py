...
class SpeechToolResponseDataExtractionProvider(
    ...
    def extract_data(self) -> ExtractedDataProduct:
        ...
        return ConcreteExtractedDataProduct({'name': arguments.get('name'),
                                             'speech': arguments.get('speech'), 'narration_text': arguments.
                                            get('narration_text')})
