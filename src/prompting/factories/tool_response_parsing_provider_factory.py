...
class ToolResponseParsingProviderFactory:
    ...
    @staticmethod
    def create_tool_response_parsing_provider(
        llm_content_product: LlmContentProduct,
    ) -> ToolResponseParsingProvider:
        return ConcreteToolResponseParsingProvider(llm_content_product.get())
