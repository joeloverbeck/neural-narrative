...
class ProduceToolResponseStrategyFactory:
    ...
    def create_produce_tool_response_strategy(self
                                              ) -> ProduceToolResponseStrategy:
        llm_content_provider_factory = LlmContentProviderFactory(self.
                                                                 _llm_client, model=self._model)
