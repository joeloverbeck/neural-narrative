...
class CharacterGenerationInstructionsFormatterFactory:
    ...
    def __init__(self, playthrough_name: str, places_descriptions_provider:
    PlacesDescriptionsProvider):
        self._playthrough_name = playthrough_name
        self._places_descriptions_provider = places_descriptions_provider

    def create_formatter(self, templates: dict
                         ) -> CharacterGenerationInstructionsFormatter:
        return CharacterGenerationInstructionsFormatter(self.
                                                        _playthrough_name, self._places_descriptions_provider.
                                                        get_information(), templates)
