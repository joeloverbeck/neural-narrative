...
class CharacterChoiceDialogueLlmContentProviderFactory:
    ...
    def create_llm_content_provider_factory(self,
                                            character_choice_dialogue_initial_prompting_messages_product: InitialPromptingMessagesProduct) -> LlmContentProvider:
        return ConcreteLlmContentProvider(model=self._model,
