...
class LlmContentProviderFactory:
    ...
    def create_llm_content_provider(self, messages_to_llm: MessagesToLlm) -> LlmContentProvider:
        return ConcreteLlmContentProvider(self._model, messages_to_llm, self._llm_client)
