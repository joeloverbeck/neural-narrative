...
class ProduceActionResolutionAlgorithm:
    ...
    def __init__(self, playthrough_name: str, action_resolution_factory:
    BaseToolResponseProvider, store_action_resolution_algorithm:
    StoreActionResolutionAlgorithm,
        ...
        self._store_action_resolution_algorithm = (
    ...
    def do_algorithm(self) -> ActionResolutionProduct:
        product = cast(ActionResolutionProduct, self.
                       _action_resolution_factory.generate_product())
        ...
        self._produce_voice_lines_for_action_resolution_algorithm.do_algorithm(
            product)
        return product
