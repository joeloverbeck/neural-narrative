...
from src.characters.algorithms.produce_self_reflection_algorithm import ProduceSelfReflectionAlgorithm
...
class CharacterMemoriesView(MethodView):
    ...
    def get(self):
        ...
        if selected_character_identifier:
            ...
            character_memories = CharacterMemories(playthrough_name
        ...
        return render_template('character-memories.html', all_characters=
        all_characters, selected_character=selected_character,
                               character_memories=character_memories, self_reflection_text=
                               self_reflection_text, self_reflection_voice_line_url=
                               self_reflection_voice_line_url)
    ...
    def post(self):
        ...
        if action == 'save_memories' and character_identifier:
            ...
            new_memories = (WebInterfaceManager.
                            remove_excessive_newline_characters(new_memories))
            CharacterMemories(playthrough_name).save_memories(Character(
                playthrough_name, character_identifier), new_memories)
            ...
            algorithm = ProduceSelfReflectionAlgorithm(playthrough_name,
                                                       character_identifier, SelfReflectionFactory(
                    playthrough_name, character_identifier,
                    produce_tool_response_strategy_factory,
            ...
            session['self_reflection_voice_line_url'
            ] = WebService.get_file_url('voice_lines',
        ...
        return redirect(url_for('character-memories', character_identifier=
