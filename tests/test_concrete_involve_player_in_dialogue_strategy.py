...
def test_do_algorithm_goodbye(strategy, mock_player_input_factory, mock_player_input_product, mock_transcription):
    mock_player_input_factory.create_player_input.return_value = mock_player_input_product
...
def test_do_algorithm_silent_player(strategy, mock_player_input_factory, mock_player_input_product, mock_transcription):
    mock_player_input_factory.create_player_input.return_value = mock_player_input_product
...
def test_do_algorithm_with_input(strategy, mock_player_input_factory, mock_player_input_product, mock_command_factory,
                                 mock_observer, mock_transcription):
    mock_player_input_factory.create_player_input.return_value = mock_player_input_product
    mock_player_input_product.is_goodbye.return_value = False
    mock_player_input_product.is_silent.return_value = False

    mock_command = Mock()
    mock_command_factory.create_introduce_player_input_into_dialogue_command.return_value = mock_command
