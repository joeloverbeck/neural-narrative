...
def test_add_existing_participant():
    ...
    participants.add_participant(
        "1", "Alice", "description", "friendly", "equipment", "default_model"
    )
    participants.add_participant(
        "2", "Bob", "description", "serious", "equipment", "default_model"
    )
...
def test_add_new_participant():
    ...
    assert (
        "2" in participants._participants
    ), "New participant key '2' should be present."
